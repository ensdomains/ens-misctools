  ...
  return (
    <>
      ...
      <div className={styles.container}>
        ...
        <Card>
          <Link href="/setprimary" legacyBehavior>
            <a>
        ...
        <Card>
          <Link href="/unwrap" legacyBehavior>
            <a>
        ...
        <Card>
          <Link href="/setprmanager" legacyBehavior>
            <a>
        ...
        <Card>
          <Link href="/setrecords" legacyBehavior>
            <a>
         ...
         <Card>
          <Link href="/dnsquery" legacyBehavior>
            <a>
